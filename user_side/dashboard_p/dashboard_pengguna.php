...
//menampilkan data agenda rapat dengan pengguna yang sedang login
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="row g-3">
            <div class="col-lg-12">
              ...
              ?>
                                <!--menampilkan detail rapat ke dalam tabel-->
                                <tr>
                                    <td><?= $no++ ?></td>
                      ...
                      ?>
                                    ...
                                    <td><span class="badge <?= $statusClass ?>"><?= strtoupper($row['status']) ?></span>
                                    </td>
                                </tr>
                                <?php 
                  endwhile;
    ...
    <!--menampilkan notifikasi ketika pengguna berhasil melakukan login-->
    <div class="notification-container">
        <div class="toast login-toast align-items-center text-white bg-success border-0" role="alert"
            aria-live="assertive" aria-atomic="true" id="loginSuccessToast">
            <div class="d-flex">
    ...
    <!--menampilkan atau menyembunyikan sidebar ketika tombol ditekan-->
    <script>
    document.getElementById('toggleBtn')?.addEventListener('click', () => {
        document.getElementById('sidebar').classList.toggle('active');
    });

    //menampilkan notifikasi otomatis setelah halaman dimuat jika terdapat session penanda login berhasil
    ...
    //pengaturan refresh halaman secara otomatis setiap 30 detik
    <?php endif; ?>
